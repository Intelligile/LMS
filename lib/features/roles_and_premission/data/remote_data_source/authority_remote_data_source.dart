...
abstract class AuthorityRemoteDataSource {
  ...
  Future<void> deletedAuthority({required int authorityId});
}
...
class AuthorityRemoteDataSourceImpl extends AuthorityRemoteDataSource {
  ...
  @override
  Future<void> deletedAuthority({required int authorityId}) async {
    await api.delete(endPoint: 'api/authorities/$authorityId', token: jwtToken);
  }
}
